...
//  def greet(): Unit = {
//    println(s"Hello, my name is $plainText and I am $algorithm years old $salt lk $nonce cc $four .")
//  }
//   def this(plainText:String,algorithm:String,salt:String,nonce:String,four:String) =
//     { this("plainText",algorithm,salt,nonce,four)}
  // Auxiliary constructor has to use def this(...)
//  def this() = {
//    this("default","","","","")
//  }
  //def this(plainText: String, algorithm: String, salt: String, nonce: String, four: String):Any
 }
